...
def BinaryTreeToString(root):
    if root.symbol is not None:
        ...
        return "(%s%s)" % (BinaryTreeToString(root.left), BinaryTreeToString(root.right))
...
if __name__ == "__main__":
    ...
    for l in f.readlines():
        l = l.strip()
        (testname, symbols, weights, tree, encode_input,
         encode_output, decode_input, decode_output) = l.split(";")
